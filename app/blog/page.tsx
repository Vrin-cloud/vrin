...
export default function BlogPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen">
          ...
          <div className="container max-w-6xl">
            ...
            >
              <Link href={`/blog/${featuredPosts[0].slug}`}>
                <Card className="group overflow-hidden border border-[#201E1E]/10 dark:border-[#FFFFFF]/10 bg-gradient-to-br from-[#083C5E]/5 to-[#8DAA9D]/5 dark:from-[#083C5E]/20 dark:to-[#8DAA9D]/10 hover:shadow-xl transition-all duration-300">
                  <CardContent className="p-8 md:p-12">
                    ...
                    <h2 className="text-2xl md:text-3xl lg:text-4xl font-light mb-4 text-[#201E1E] dark:text-[#FFFFFF] group-hover:text-[#083C5E] dark:group-hover:text-[#8DAA9D] transition-colors">
                      {featuredPosts[0].title}
                    </h2>
                    <p className="text-[#201E1E]/60 dark:text-[#FFFFFF]/60 text-lg mb-6 max-w-3xl">
                      {featuredPosts[0].description}
                    </p>
                    <div className="flex flex-wrap items-center gap-4 text-sm text-[#201E1E]/50 dark:text-[#FFFFFF]/50">
      ...
      {/* All Posts */}
      <section className="py-16 bg-[#FFFFFF] dark:bg-[#201E1E]">
        <div className="container max-w-6xl">
            ...
            {allPosts.map((post, index) => (
              ...
              >
                <Link href={`/blog/${post.slug}`}>
                  <Card className="group h-full overflow-hidden border border-[#201E1E]/10 dark:border-[#FFFFFF]/10 hover:border-[#083C5E]/30 dark:hover:border-[#8DAA9D]/30 bg-[#FFFFFF] dark:bg-[#201E1E] hover:shadow-lg transition-all duration-300">
                    <CardContent className="p-6 flex flex-col h-full">
                      ...
                      <h3 className="text-lg font-medium mb-3 text-[#201E1E] dark:text-[#FFFFFF] group-hover:text-[#083C5E] dark:group-hover:text-[#8DAA9D] transition-colors line-clamp-2">
                        {post.title}
                      </h3>
                      <p className="text-sm text-[#201E1E]/60 dark:text-[#FFFFFF]/60 mb-4 line-clamp-3 flex-grow">
                        {post.description}
                      </p>
                      <div className="flex items-center gap-4 text-xs text-[#201E1E]/50 dark:text-[#FFFFFF]/50 pt-4 border-t border-[#201E1E]/5 dark:border-[#FFFFFF]/5">
        ...
        <div className="container max-w-6xl">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
            {BLOG_CATEGORIES.map((category) => (
              <Card
                key={category.id}
                className="border border-[#201E1E]/10 dark:border-[#FFFFFF]/10 bg-[#FFFFFF] dark:bg-[#201E1E]"
              >
                <CardContent className="p-5">
                  <h3 className="font-medium mb-2 text-[#201E1E] dark:text-[#FFFFFF]">
                    {category.name}
                  </h3>
