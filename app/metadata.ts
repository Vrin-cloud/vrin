...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    // Knowledge & search
    "knowledge reasoning infrastructure", "enterprise knowledge infrastructure", "AI search engine",
    "semantic search AI", "intelligent search", "AI-powered search", "traceable AI answers",
    // Enterprise & business
