          ...
          >
            <div className="bg-white border border-gray-200 rounded-2xl p-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <a href="https://cal.com/vedant-vrin/book-a-demo" target="_blank" rel="noopener noreferrer" className="inline-flex items-center px-6 py-3 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition-colors font-semibold">
